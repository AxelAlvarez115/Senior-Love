...
const adminController = {
    home: async (req, res) => {
        try {
            ...
            res.render('admin/index', { stats: { userCount, eventCount, commentCount, interestCount } });
        } catch (error) {
            console.error(error);
            res.render('admin/index', { stats: { userCount: 0, eventCount: 0, commentCount: 0, interestCount: 0 } });
        }
    },
